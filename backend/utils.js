...
7. For empty notes, generate detailed, informative, and visually structured HTML content with headings, bullet points, examples, explanations, and organized formatting.
8. Structured outputs (tables, checklists) allowed; keep safe and minimal.
9. Output must be deterministic; JSON must never break.
10. CRITICAL: Generate a UNIQUE response strictly based on the User request. Do NOT output generic templates.
`;
